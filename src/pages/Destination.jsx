...
const Destination = () => {
	...
	return (
		<section className=" uppercase flex items-center justify-center lg:justify-between gap-12 flex-col lg:flex-row h-full text-white">
			...
			<div className="flex flex-col items-center lg:items-start justify-center lg:max-w-[50%] mt-10">
