...
const Crew = () => {
	...
	return (
		<section className=" uppercase flex items-center justify-center lg:justify-between gap-12 flex-col lg:flex-row h-screen text-white">
			<div className=" h-full flex flex-col items-center justify-between">
				...
				<div className="flex flex-col items-center text-center lg:text-start gap-10 max-w-[70%]">
					<div>
						...
						<p className="text-sm pb-8 capitalize ">{selectedCrew.bio}</p>
					</div>
				</div>
			...
			<img
				...
				className="w-48 lg:w-80 xl:w-96 h-1/2"
			/>
		</section>
	);
};
