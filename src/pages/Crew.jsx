...
const Crew = () => {
	...
	return (
		<section className=" flex items-center justify-center lg:justify-between gap-12 flex-col lg:flex-row sm:h-[60vh] text-white">
			<div className=" h-full flex flex-col items-center gap-5 justify-between">
				...
				<div className="flex flex-col items-center text-center lg:text-start gap-10 max-w-[70%]">
					<div>
						...
						<p className="text-lg pb-8 lg:max-w-[70%] ">{selectedCrew.bio}</p>
					</div>
				</div>
